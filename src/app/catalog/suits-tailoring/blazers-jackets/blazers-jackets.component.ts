...
export class BlazersJacketsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private fetchCatalogData() {
    this.loading = true;
    return this.blazers_jacketsService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.blazers_jacketsService.getBlazersJacketsByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
