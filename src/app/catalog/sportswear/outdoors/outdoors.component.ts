...
export class OutdoorsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private outdoorsService: OutdoorsService,
  ...
  private fetchCatalogData(): Observable<Item[]> {
    this.loading = true;
    return this.outdoorsService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.outdoorsService.getOutdoorsByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
