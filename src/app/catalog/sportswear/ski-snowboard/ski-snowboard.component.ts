...
export class SkiSnowboardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const ski_snowboardSubscription = this.userStateMgmnt.getUserState()
      .pipe(
        ...
        switchMap(itms => {
          ...
          return this.ski_snowboardService.getSkiSnowboard();
        }),
        takeUntil(this.destroy$),
    ...
    this.unsubscriptionArray.push(ski_snowboardSubscription);
  }
