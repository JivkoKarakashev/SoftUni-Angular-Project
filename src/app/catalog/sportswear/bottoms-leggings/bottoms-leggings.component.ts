...
export class BottomsLeggingsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const bottoms_leggingsSubscription = this.userStateMgmnt.getUserState()
      .pipe(
        ...
        switchMap(itms => {
          ...
          return this.bottoms_leggingsService.getBottomsLeggings();
        }),
        takeUntil(this.destroy$),
    ...
    this.unsubscriptionArray.push(bottoms_leggingsSubscription);
  }
