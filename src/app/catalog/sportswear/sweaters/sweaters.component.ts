...
export class SweatersComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private sweatersService: SweatersService,
  ...
  private fetchCatalogData() {
    this.loading = true;
    return this.sweatersService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.sweatersService.getSweatersByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
