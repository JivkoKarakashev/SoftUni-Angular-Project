...
export class SportswearComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private sportswearService: SportswearService,
  ...
  ngOnInit(): void {
    ...
    const categoryUrls = this.sportswearService.getCategoryUrls();
  ...
  private fetchCatalogData(): Observable<Array<Item[]>> {
    this.loading = true;
    return this.sportswearService.getCollectionComposition()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(compArr => {
          ...
          ///////////////////////////////////////
          return this.sportswearService.getSportswearByPage([...this.paginationConfig.subcategoryConfigs])
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
