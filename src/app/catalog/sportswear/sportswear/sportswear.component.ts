...
export class SportswearComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const sportswearSubscription = this.userStateMgmnt.getUserState()
      .pipe(
        ...
        switchMap(itms => {
          ...
          return this.sportswearService.getSportswear();
        }),
        takeUntil(this.destroy$),
    ...
    this.unsubscriptionArray.push(sportswearSubscription);
  }
