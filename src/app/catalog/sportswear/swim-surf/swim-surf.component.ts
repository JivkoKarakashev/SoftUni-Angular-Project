...
export class SwimSurfComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const swim_surfSubscription = this.userStateMgmnt.getUserState()
      .pipe(
        ...
        switchMap(itms => {
          ...
          return this.swim_surfService.getSwimSurf();
        }),
        takeUntil(this.destroy$),
    ...
    this.unsubscriptionArray.push(swim_surfSubscription);
  }
