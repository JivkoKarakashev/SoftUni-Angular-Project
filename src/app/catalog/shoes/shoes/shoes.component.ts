...
export class ShoesComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const categoryUrls = this.shoesService.getCategoryUrls();
  ...
  private fetchCatalogData(): Observable<Array<Item[]>> {
    this.loading = true;
    return this.shoesService.getCollectionComposition()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(compArr => {
          ...
          ///////////////////////////////////////
          return this.shoesService.getShoesByPage([...this.paginationConfig.subcategoryConfigs])
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
