...
export class SunglassesComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private fetchCatalogData(): Observable<Item[]> {
    this.loading = true;
    return this.sunglassesService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.sunglassesService.getSunglassesByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
