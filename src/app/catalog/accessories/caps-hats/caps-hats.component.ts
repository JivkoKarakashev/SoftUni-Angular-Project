...
export class CapsHatsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const caps_hatsSubscription = this.userStateMgmnt.getUserState()
      .pipe(
        ...
        switchMap(itms => {
          ...
          return this.caps_hatsService.getCapsHats();
        }),
        takeUntil(this.destroy$),
    ...
    this.unsubscriptionArray.push(caps_hatsSubscription);
  }
