...
export class JacketsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private jacketsService: JacketsService,
  ...
  private fetchCatalogData() {
    this.loading = true;
    return this.jacketsService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.jacketsService.getJacketsByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
