...
export class ClothesComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const categoryUrls = this.clothesService.getCategoryUrls();
  ...
  private fetchCatalogData(): Observable<Array<Item[]>> {
    this.loading = true;
    return this.clothesService.getCollectionComposition()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(compArr => {
          ...
          ///////////////////////////////////////
          return this.clothesService.getClothesByPage([...this.paginationConfig.subcategoryConfigs])
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
