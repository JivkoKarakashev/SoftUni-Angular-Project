...
export class LongwearComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private longwearService: LongwearService,
  ...
  private fetchCatalogData(): Observable<Item[]> {
    this.loading = true;
    return this.longwearService.getCollectionSize()
      .pipe(
        catchError(err => {
          this.loading = false;
          this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
        ...
        switchMap(collSize => {
          ...
          ///////////////////////////////////////
          return this.longwearService.getLongwearByPage(this.paginationConfig.skipSizeReq, this.paginationConfig.pageSizeReq)
            .pipe(
              catchError(err => {
                this.loading = false;
                this.errorsService.sethttpErrorsArrState([...this.httpErrorsArr, { ...err }]);
